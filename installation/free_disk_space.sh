...
sudo apt-get -qq remove-y '^ghc-8.*'
sudo apt-get -qq remove-y '^dotnet-.*'
sudo apt-get -qq remove-y '^llvm-.*'
sudo apt-get -qq remove-y 'php.*'
sudo apt-get -qq remove-y azure-cli google-cloud-sdk hhvm google-chrome-stable firefox powershell mono-devel
